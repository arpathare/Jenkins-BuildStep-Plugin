 ...
 * {@link PluginBuilder} is created. The created instance is persisted to
 * the project configuration XML by using XStream, so this allows you to use
 * instance fields (like {@link #getOffer}) to remember the configuration.
 *
 * <p>
...
public class PluginBuilder extends Builder {
    ...
    /**
     * Descriptor for {@link PluginBuilder}. Used as a singleton. The class is
     * marked as public so that it can be accessed from views.
     *
     * <p>
     * See
     * {@code src/main/resources/com/plugin/buildplugin/*.jelly}
